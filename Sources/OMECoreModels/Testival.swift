...
public extension Stage {
    static let previewValues: [Stage] = [
        Stage(
            ...
            name: "Unicorn Lounge",
            iconImageURL: URL(
                string: "https://firebasestorage.googleapis.com:443/v0/b/festivl.appspot.com/o/userContent%2FF0BC110C-D42E-4CC9-BED3-59E2700938FF.png?alt=media&token=472a66e1-c45a-4a67-895a-5ec7e0ad95c0"
            ),
            color: 0xBC60A4
        ),
